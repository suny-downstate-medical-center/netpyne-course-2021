...
cfg.recordTraces['V_dend'] = {'sec':'dend', 'loc':1.0, 'var': 'v'}
cfg.recordTraces['gNa_soma'] = {'sec':'soma', 'loc':0.5, 'mech':'hh', 'var':'gna'}
cfg.recordTraces['gK_soma'] = {'sec':'soma', 'loc':0.5, 'mech':'hh', 'var':'gk'}
